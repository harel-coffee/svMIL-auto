...
class InputDataParser:
	"""	
		The purpose of this class is to handle all functionality related to reading and parsing input files. This includes sorting of the data
	"""
			
	def parseInputData(self, inFile):
		"""
	...
	def prepareInputData(self, inputData):
		"""
