...
#	This workflow is specific for the CTCF-based runs. THe only difference is the
#	settings and output file locations.
...
## path here
settingsFolder='./settings/settings_HMF_Breast_CTCF'
...
outputFolder='output/HMF_Breast_CTCF'
...
if $run; then
	...
	python "$runFolder/runMILClassifier.py" "$outputFolder" "False" "True" "False" "False" "False" "False"
