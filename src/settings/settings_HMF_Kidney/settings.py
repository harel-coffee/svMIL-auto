files = dict(
	...
	tadFile = "../data/tads/kidney/Caki2_raw-rep1_TADs.txt",
	eQTLFile = '../data/eQTLs/gm12878/blood_eQTLs.bed_clustered.bed', #missing specific data
	enhancerFile = '../data/enhancers/kidney/fantom5_elasticnet.11.csv',
	h3k4me3 = '../data/histones/kidney/ENCFF423PKK_h3k4me3.bed_clustered.bed',
	h3k27ac = '../data/histones/kidney/ENCFF926MNC_h3k27ac.bed_clustered.bed',
	h3k27me3 = '../data/histones/kidney/ENCFF983CPK_h3k27me3.bed_clustered.bed',
	h3k4me1 = '../data/histones/kidney/ENCFF653PGR_h3k4me1.bed_clustered.bed',
	dnaseIFile = '../data/dnase/kidney/ENCFF732RRW.bed',
	...
	ctcfFile = '../data/ctcf/kidney/ENCFF328FUO.bed'
...
general = dict(
	...
	source = 'HMF',
	cancerType = 'Kidney', #is used to get the right cancer type from the data, use the cancer type name used in the metadata.
