files = dict(
	...
	tadFile = "../data/tads/pancreas/Pancreas_Donor-PA2-raw_TADs.txt",
	eQTLFile = '../data/eQTLs/pancreas/pancreas_eQTLs.bed_clustered.bed',
	enhancerFile = '../data/enhancers/pancreas/encoderoadmap_elasticnet.96.csv',
	h3k4me3 = '../data/histones/pancreas/ENCFF931ZDN_h3k4me3.bed_clustered.bed',
	h3k27ac = '../data/histones/pancreas/ENCFF505THV_h3k27ac.bed_clustered.bed',
	h3k27me3 = '../data/histones/pancreas/ENCFF940QJC_h3k27me3.bed_clustered.bed',
	h3k4me1 = '../data/histones/pancreas/ENCFF215TJZ_h3k4me1.bed_clustered.bed',
	dnaseIFile = '../data/dnase/pancreas/ENCFF897PRD.bed',
	chromHmmFile = '../data/chromhmm/hmec/GSE57498_HMEC_ChromHMM.bed', #use hmec, missing for blood also
	rnaPolFile = '../data/rnapol/pancreas/ENCFF386FNQ.bed',
	superEnhancerFile = '../data/superEnhancers/pancreas/Pancreas.bed',
	ctcfFile = '../data/ctcf/pancreas/ENCFF823LGP.bed'
...
general = dict(
	...
	source = 'HMF',
	cancerType = 'Pancreas', #is used to get the right cancer type from the data, use the cancer type name used in the metadata.
